...
//$config['sandbox'] = ($general_settings['paypal_sandbox'] == 1) ? TRUE : FALSE; // FALSE for live environment( old code)

$config['sandbox'] = ($general_settings['paypal_is_sandbox'] == 1) ? TRUE : FALSE; // FALSE for live environment
