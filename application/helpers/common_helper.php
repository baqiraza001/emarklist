<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function get_bussiness_profile($id)
    {
        ...
        function get_bussiness_profile_image($id)
    {

         $ci = & get_instance();
        return $ci->db->select('company_logo')
        ->where('id',$id)
        ->get('xx_companies')
        ->row_array()['company_logo'];
    }

    function get_service_image($id)
    {

         $ci = & get_instance();
          // return $this->db->query("SELECT * FROM xx_service_media WHERE job/service_id=".$id." ")->result_array();
         $image=$ci->db->select('*')->where('job/service_id',$id)->get('xx_service_media')->result_array();
         return $image;
    }
    function get_deals_image($id)
    {

         $ci = & get_instance();
          // return $this->db->query("SELECT * FROM xx_service_media WHERE job/service_id=".$id." ")->result_array();
         $image=$ci->db->select('*')->where('deal_id',$id)->get('xx_deal_media')->result_array();
         return $image;
    }
    function get_products_image($id)
    {
         ...
         $ci = & get_instance();
          // return $this->db->query("SELECT * FROM xx_service_media WHERE job/service_id=".$id." ")->result_array();
         $image=$ci->db->select('*')->where('product_id',$id)->get('xx_product_media')->result_array();
         return $image;
    }
    ...
    {
        $ci = & get_instance();
        return $ci->db->get('xx_service_type')->result_array();
    }
     function get_service_type_list_for_show()
    {
        $ci = & get_instance();
        return $ci->db->get('xx_service_type')->result_array();
    }
    ...
    function get_user_cell_no($user_id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_users', array('id' => $user_id))->row_array()['mobile_no'];
    }
    // Get User address
    function get_user_address($user_id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_users', array('id' => $user_id))->row_array()['address'];
    }
    // Get User state
    function get_user_state($user_id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_users', array('id' => $user_id))->row_array()['state'];
    }
    // Get User city
    function get_user_city($user_id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_users', array('id' => $user_id))->row_array()['city'];
    }
    ...
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_product_post', array('id' => $id))->row_array()['brand_name'];
    }  
    // Get product title Name by id
    function get_product_title($id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_product_post', array('id' => $id))->row_array()['title'];
    }
    // Get product image name by id
    function get_product_image_name($id)
    {
        $ci = & get_instance();
        return $ci->db->get_where('xx_product_media', array('id' => $id))->row_array()['name'];
    }   
