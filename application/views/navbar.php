...
<!--               <li><a href="<?= base_url('employers') ?>"><?=trans('label_for_employers')?></a>
              ...
              <li><a href="<?= base_url('bussiness') ?>"><?=trans('label_for_virtual_jobs')?></a>
               ...
               <li>
              <a class="nav_btn mt-1" href="<?= base_url('bussiness') ?>"><i class="lnr lnr-briefcase pr-1"></i><?=trans('label_for_local_bussiness')?></a>
             </li>
            <li>
              <a class="nav_btn mt-1" href="<?= base_url('employers/cv/search') ?>"><i class="lnr lnr-briefcase pr-1"></i><?=trans('label_for_virtual_jobs')?>
              </a> 
            </li>  
                <?php 
           ...
           <?php     }
            ...
            <li><a class="ticker-btn-nav btn_login mt-1" href="<?= base_url('auth/login') ?>"><i class="lnr lnr-user pr-1"></i> <?=trans('label_login')?></a></li>
              ...
              ?>
            <li class=""><a href="<?= base_url('jobs/daily_deals'); ?>"><?=trans('label_companies')?></a></li>
            <li class=""><a href="<?= base_url('blog'); ?>"><?=trans('label_blog')?></a>
              <ul>
                <li><a href="<?= base_url('blog/business_pricing'); ?>">Business Pricing</a></li>
                <li><a href="<?= base_url('blog/job_pricing'); ?>">Job Pricing</a></li> 
            ...
            <li>
              <a class="nav_btn mt-1" href="<?= base_url('home') ?>"><i class="lnr lnr-briefcase pr-1"></i>Jobs Portal</a> 
            </li>
            <li><a class="ticker-btn-nav btn_login mt-1" href="<?= base_url('auth/login') ?>"><i class="lnr lnr-user pr-1"></i> <?=trans('label_login')?></a>
            </li>
            <?php }
              ?> 
