...
<footer class="footer-area footer-section">
  <div class="container">
    <div class="row">
      ...
      if ($col['title']!='about_us') {
        ?>

      <div class="col-lg-<?= $col['grid_column'] ?>  col-md-<?= $col['grid_column'] ?> col-sm-6">
        <div class="single-footer-widget newsletter">
          <h6 style="color: #428bca"><?=strtoupper(trans($col['title']))?></h6>
          <?= $col['content'] ?>
        </div>
      </div>
    ...
    <div class="row"> 
      <div class="col-md-6 col-8">
        <div class="bottom_footer_info">
          ...
          <p><img width="20%" src="<?= base_url($this->general_settings['logo']); ?>" alt="" title="" /> &nbsp;&nbsp;&nbsp;<?= $this->general_settings['copyright']?></p>
        </div>
      </div>
