    ...
    <div class="row">
        <div class="col-md-12">
          <div class="box box-body">
            <div class="col-md-6">
              <h4><i class="fa fa-list"></i> &nbsp; Bussiness Lister</h4>
          </div>
          <div class="col-md-6 text-right">
              <a href="<?= base_url('admin/Bussiness_lister/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Bussiness Lister</a>
          </div>
        </div>
    </div>
    </div>
...
var table = $('#na_datatable').DataTable( {
  "processing": true,
  "serverSide": true,
  "ajax": "<?=base_url('admin/Bussiness_lister/datatable_json')?>",
  "order": [[1,'desc']],
  "columnDefs": [
...
{
	$.post('<?=base_url('admin/Bussiness_lister/search')?>',$('#employer_search').serialize(),function(){
