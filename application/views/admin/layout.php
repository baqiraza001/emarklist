...
<html lang="en">
	<head>
		  ...
		  <meta name = "keywords" content = "Admin Panel, Backend Panel, user management system" />
      	  <meta name = "description" content = "Cutting Edge solution for perfect admin panel." />
      	  <meta name = "author" content = "BFTech" />
		  <!-- Bootstrap 3.3.6 -->
		...
		<div class="wrapper" style="height: auto;">
			...
			<section id="container">
				...
				<footer class="main-footer">
					<strong>Copyright © 2020 <a href="https://www.bftech.uk">BFTech</a></strong> All rights
					reserved.
				</footer>
				<!--footer end-->
			</section>
