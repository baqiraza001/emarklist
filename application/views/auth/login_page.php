    ...
    <div class="wrap-login100">
      ...
      <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
        <li class="nav-item">
         ...
         // echo "string";
          ?>
          <a class="nav-link <?= ($this->uri->segment(1) == 'auth')? 'active': '' ?>" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><?=trans('job_seeker')?></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($this->uri->segment(1) == 'Business')? 'active': '' ?>" id="pills-profile-tab2" data-toggle="pill" href="#pills-profile2" role="tab" aria-controls="pills-profile2" aria-selected="false"><?=trans('Business')?></a>
        </li>
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <!-- Bussiness Login Page -->
        <div class="tab-pane fade <?= ($this->uri->segment(1) == 'Bussiness')? 'show active': '' ?>" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab2">
          <?php $attributes = array('id' => 'login_form', 'method' => 'post' , 'class' => 'login100-form validate-form');
            echo form_open('bussiness/auth/login',$attributes);?>
          ...
          <div class="text-center w-full pt-4">
              <a class="txt1 bo1 hov1" href="<?= base_url(); ?>bussiness/auth/forgot_password">
                <?=trans('forgot_pass')?>
              </a>
          </div>
          <div class="text-center w-full pt-3">
              ...
              <a class="txt1 bo1 hov1" href="<?= base_url(); ?>bussiness/auth/registration">
                <?=trans('signup_now')?>
              </a>
          </div>
        </div>
