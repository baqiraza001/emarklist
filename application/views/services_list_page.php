          ...
          echo form_open('services/search',$attributes);?>
	                <div class="row justify-content-center form-wrap no-gutters">
	                  <!-- <div class="col-lg-6 form-cols">
	                    <input type="text" class="form-control" name="bussiness_name" value="<?php if(isset($search_value['title'])) echo str_replace('-', ' ', $search_value['title']); ?>" placeholder="<?=trans('what_looking')?>">
	                  </div> -->
	              <div class="col-lg-4 form-cols">

              <input type="text" class="form-control" name="bussiness_name" placeholder="Bussiness Name" value="<?php if(isset($search_value['company_id']))
              				{ 
              					echo get_company_name($search_value['company_id']);
              				}
              				else{
              				echo $company_name;	
              				} ?>">
            ...
            <div class="col-lg-4 form-cols">
              <input type="text" class="form-control" name="Services" placeholder="Services" value="<?php if(isset($search_value['title'])) echo str_replace('-', ' ', $search_value['title']); ?>">
            </div>
...
$("#experience_toggle").click(function(){
  ...
  $("#emp_toggle").click(function(){
    $("#employer_list").slideToggle("slow");
  });
			...
			<div class="col-lg-4 order-2 sidebar search" style="background-color: #f9f9ff;">
			...
			<?php $category_id = (isset($search_value['category']))? $search_value['category']: '';  ?>
				...
				<div class="single-slidebar">
					<div id="experience_toggle">
					<h4><?=trans('experience')?><i class="fa fa-caret-down"></i></h4>
					</div>
				...
				<div class="single-slidebar">
					<div id="job_toggle">
					<h4><?=trans('job_type')?><i class="fa fa-caret-down"></i></h4>
					</div>
					<?php 
