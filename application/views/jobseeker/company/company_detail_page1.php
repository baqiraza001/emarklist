...
<section class="post-area  pt-5 pb-5" style="margin-top: 60px;">
  <div class="container">
    ...
    <div class="row justify-content-center d-flex">
      <div class="col-lg-2" style="border:1px solid #d4d4d4; border-radius: 6px;">
        <div style="">
          <img src="http://localhost/joblist/assets/img/job_icon.png" alt="" style="width:100%; height:100%" width="100%" height="auto">         
        </div>
      </div>
      <div class="col-lg-8">
      ...
      <div class="col-lg-10"> 
        ...
        <div class="row pb-1">
          <div class="col-lg-6">
            ...
            <div class="profile_job_detail">  
              <p class="font_details"><?= $company_info['category']; ?></p> 
            </div> 
          </div>
          <div class="col-lg-6 ">
            <div class="headline">
