  ...
  <div class="wrap-login100" style="width: 650px;">
    <div class="container">
      <span class="login100-form-title pb-5">
       <?=trans('signup')?> <small>(<?=trans('Business')?>)</small>
      </span>
      ...
      <?php echo form_open('bussiness/auth/registration',$attributes); ?>
      <div class="row">
        <div class="col-lg-6">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="form-group">
          <input type="checkbox" name="termsncondition"> 
            <a href="<?php echo base_url();?>bussiness/auth/terms_condition/" class="input-btn input-btn-large font-style"><?=trans('agree_to_our')?> <small> <?=trans('terms_and_cond')?>
          </a>
          </small>
    ...
    <div class="text-center w-full pt-4">
          ...
          <a class="txt1 bo1 hov1" href="<?= base_url();?>bussiness/Auth/login/">
            <?=trans('signin_now')?>
          </a>
      </div>
  </div>  
