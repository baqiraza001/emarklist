		...
		<div class="container">
			<div class="row justify-content-center d-flex">
				...
				<div class="col-lg-8 post-list">
					...
					<?php echo form_open_multipart('bussiness/company',$attributes);?>
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-12">
									<div class="submit-field">
										...
										<div class="col-md-12 col-sm-12">
											<div class="submit-field">
												<h5><?=trans('select_package')?> *</h5>
												<select name="package" class="form-control">
													<option value="1" <?php if($company_info['package'] == '1'){ echo "selected";} ?>>Post Job
													</option>
													<option value="2" <?php if($company_info['package'] == '2'){ echo "selected";} ?>>Post Services
													</option>
													<option value="3" <?php if($company_info['package'] == '3'){ echo "selected";} ?>>Both
													</option>
												</select>
											</div>
										</div>
