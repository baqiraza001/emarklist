         ...
         <div class="col-md-6 col-sm-12 mb-20">
          <div class="onjob-employer-resumes-wrap">
            <figure class="pp">
              <figcaption>
                ...
                if ($applicant['resume_path']!="") {
                  ?>
                 <a href="<?= base_url($applicant['resume_path']); ?>" class="onjob-resumes-download"><i class="lnr lnr-download"></i> <?=trans('download_cv')?></a>
                <?php 
                }
                elseif ($applicant['resume_path']=="") {
                 ?>
                  <a href="<?= base_url($applicant['resume']); ?>" class="onjob-resumes-download"><i class="lnr lnr-download"></i> <?=trans('download_cv')?></a>
                 <?php
                }
                ?> 
                </h2>
            ...
            <ul class="onjob-resumes-options">
              ...
              <!-- <li>
              <a href="<?php echo base_url();?>Zoom_Api/meeting">meeting chceck</a>
              </li> -->
