	...
	<div class="container">
		...
		<div class="row d-flex align-items-center justify-content-center">
			...
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="<?= base_url('bussiness'); ?>"><?=trans('label_home')?> </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> <?=trans('label_dashboard')?> </a></p>
...
<!-- 							   <i class="fa fa-bullhorn fa-2x mb-3"></i> -->
							   ...
							   <h4 class="mb-3"><?=trans('total_service_posted')?></h4>

							   <h5><?= $total_posted_services ?></h5>
...
<!-- 							   <i class="fa fa-shield fa-2x mb-3"></i> -->
					...
					<div class="col-md-6">
						...
						<div class="card text-center">
							...
							<div class="card-body" style="height: 106.5px">

			    <a href="<?= base_url('bussiness/packages/bought'); ?>">
			    	<!-- <i class="fa fa-list fa-2x "></i> --></a>
							   <h4 ><?=trans('active_package')?></h4>

							   <a class="btn btn-outline" style="font-size: 14px;"><?= $current_package['title'] ?></a>
