  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        ...
        <p class="text-white link-nav"><a href="<?= base_url('bussiness'); ?>"><?=trans('label_home')?> </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> <?=trans('label_manage_jobs')?></a></p>
      </div>                      
    </div>
  </div>
</section>
          ...
          <div class="headline">
            <div class="row">
              <div class="col-12">
                ...
                <a class="btn btn-info float-right" href="<?= base_url('bussiness/job/post'); ?>"><?=trans('post_new_job')?></a>
              </div>
          </div>  
        </div>
