...
class Home extends Main_Controller {
	...
	public function index()
	{
		...
		$data['jobs'] = $this->package_model->get_jobs(12,0);

		$data['services'] = $this->package_model->get_services(12,0);

		$data['products'] = $this->package_model->get_products(12,0);

		$data['deals'] = $this->package_model->get_jobs(12,0);

		$data['companies'] =  $this->package_model->get_companies_having_active_jobs(12);
