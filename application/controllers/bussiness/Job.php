...
class Job extends Main_Controller {
	...
	public function post()
	{
		...
		if ($this->input->post('post_job')) {
			...
			$data['layout'] = 'bussiness/jobs/post_job_page';
			$this->load->view('layout', $data);
		}
	}
//---------------------------------------------------------------------------------------
	...
	public function listing()
	{
		...
		$data['layout'] = 'bussiness/jobs/job_listing_page';
		$this->load->view('layout', $data);
	}
	...
	public function edit($job_id=0)
	{
		...
		if ($this->input->post('edit_job')) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url('bussiness/job/edit/'.$job_id),'refresh');
			...
			$data['layout'] = 'bussiness/jobs/edit_job_page';
			$this->load->view('layout', $data);
		}
	}
