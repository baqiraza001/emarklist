...
class Packages extends Main_Controller {
	...
	{	
		...
		$data['layout'] = 'bussiness/packages/packages_list';
	...
	{	
		...
		$data['layout'] = 'bussiness/packages/employer_packages_bought';

		$this->load->view('layout', $data);

	}

	public function bought_new_package(){
		$emp_id = $this->session->userdata('employer_id');
		...
		$data['layout'] = 'bussiness/packages/buy_new_package';
	...
	public function order_confirmation()
	{
		...
		$data['layout'] = 'bussiness/packages/order_confirmation';
        ...
        */
...

		{
...

			{
				...
				redirect(base_url('bussiness', 'refresh'));
