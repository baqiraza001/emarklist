...
class Company extends Main_Controller{
	...
	public function __construct(){
		...
		$this->load->model('bussiness/company_model','company_model');
	}
	...
	public function index(){
		...
		if ($this->input->post('update')) {
			...
			//$this->form_validation->set_rules('no_of_bussiness','no of bussiness','trim|required');
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url('bussiness/company'),'refresh');
			}
			else{
				...
				$data = array(
					...
					//'no_of_bussiness' => $this->input->post('no_of_bussiness'),
				...
				if(!empty($new_logo))
				{
					...
					else
					{
						...
						redirect(base_url('bussiness/company'));
					}
				}
				else{
			...
			$data['layout'] = 'bussiness/company/company_page';
