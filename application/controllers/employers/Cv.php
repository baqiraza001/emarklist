...
class Cv extends Main_Controller{
	...
	public function search(){
		...
		$data['jobs'] = $this->cv_model->get_jobs(100,0);
	...
	public function search_candidate(){
		...
		if($this->input->post('search'))
		{
			...
			redirect(base_url('employers/cv/search_candidate/'.$query),'refresh');
		...
		$data['layout'] = 'employers/cv_search/cv_search_page_candidate';
		$this->load->view('layout', $data);
	}
	//--------------------------------------------------------
	// Shortlist Resume
