...
{ 
	...
	{
		$data['title'] = 'Category List';
		$data['view'] = 'admin/category/service_category_list';
		$data['categories'] = $this->category_model->get_all_service_categories();
		$this->load->view('admin/layout', $data);
	}
	...
	public function add_service()
	{
		if($this->input->post()){
			...
			$data = $this->security->xss_clean($data);
			$result = $this->category_model->add_service_category($data);
			$this->session->set_flashdata('success','service category has been added successfully');
			redirect(base_url('admin/category'));
		}
		else{
			$data['title'] = 'Add Category';
			$data['view'] = 'admin/category/service_add';
			$this->load->view('admin/layout', $data);
		}
	}
	//-----------------------------------------------------
