...
class Bussiness_lister extends MY_Controller
{
	...
	public function index()
	{
		...
		$data['title'] = 'Bussiness List : OnJob';
		$data['view']  = 'admin/Bussiness/employer_list';
	...
	{				   					   
		$records = $this->employer_model->get_all_bussiness_lister();
        $data = array();
