...
class Home extends Main_Controller {
	...
	{	
		...
		$data['jobs'] = $this->home_model->get_jobs(16,0);
		$data['services'] = $this->home_model->get_services(12,0);

		$data['companies'] =  $this->home_model->get_companies_having_active_jobs(8);

		$data['company'] = $this->home_model->get_companies_having_active_jobs_service(12);
