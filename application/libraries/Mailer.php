...
class Mailer 
{
    ...
    function mail_template($to = '',$slug = '',$mail_data = '')
    {
     ...
     function mail_template_for_shortlist($to = '',$slug = '',$mail_data = '')
    {
        ...
        //$template =  $this->CI->load->view('admin/general_settings/email_templates/email_preview', $data,true);
        $template =  $this->CI->load->view('admin/general_settings/email_templates/short_list_email_preview', $data,true);
