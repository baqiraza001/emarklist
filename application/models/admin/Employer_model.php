...
{	
	...
	function get_all_employers()
    {
		...
		$this->db->join('xx_companies','xx_companies.employer_id = xx_employers.id AND xx_employers.employer_type=1','inner');
    ...
    function get_all_bussiness_lister()
    {
		$wh =array();
		...
		');
		//$this->db->join('xx_companies','xx_companies.employer_id = xx_employers.id','left');
		$this->db->join('xx_companies','xx_companies.employer_id = xx_employers.id AND xx_employers.employer_type=2','inner');
		$this->db->get('xx_employers');
